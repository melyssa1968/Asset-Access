...
async function ensureSchema() {
  if (!initialized) {
    initialized = (async () => {
      ...
      await sql`CREATE TABLE IF NOT EXISTS assets (id text PRIMARY KEY, owner_email text NOT NULL, name text NOT NULL, file_name text NOT NULL, object_key text NOT NULL, content_type text, size integer NOT NULL, created_at timestamptz NOT NULL, archived_at timestamptz)`;
